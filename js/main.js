...
const app = (() => {
  ...
  function displayNotification() {
    ...
    if (Notification.permission == 'granted') {
      navigator.serviceWorker.getRegistration().then(reg => {
        ...
        const options = {
          body: 'Payment Successful, We will ship it as soon as possible!',
  ...
  const applicationServerPublicKey = 'BJk6TbZF6HP36lr9TpAYUpe_qPWYqfBqk6KGKAmRQFAA8AlAP9cMVCOmP2v6a3jePScNtR1e_KsLf_lRIHsE3LQ';
