...
//xxxxxxxx check Address Validation xxxxxxxxxxx
function checkUserAddress(){
    ...
    if(flag){
        document.getElementById("userAddressError").style.display = "block";
    }else{
        document.getElementById("userAddressError").style.display = "none";
    }
}
//xxxxxxxx check Zip Code xxxxxxxxxxx
function checkUserZipCode(){
    ...
    if(flag){
        document.getElementById("userZipCodeError").style.display = "block";
    }else{
        document.getElementById("userZipCodeError").style.display = "none";
    }
}
//xxxxxxxx check City xxxxxxxxxxx
function checkUserCity(){
    ...
    if(flag){
        document.getElementById("userCityError").style.display = "block";
    }else{
        document.getElementById("userCityError").style.display = "none";
    }
}
//xxxxxxxx check Country xxxxxxxxxxx
...
//xxxxxxx check Phone Number xxxxxxxxxxxxxx
function checkUserPhoneNumber(){
    var userPhoneNumber = document.getElementById("userPhoneNumber");
    var userPhoneNumberFormate = /^(\+?6?01)[0-46-9]-*[0-9]{7,8}$/;
    var flag;
    if(userPhoneNumber.value.match(userPhoneNumberFormate)){
        flag = false;
    }else{
        flag = true;
    }
...
function signUp(){
    ...
    var checkUserPhoneNumberValid = userPhoneNumber.match(userPhoneNumberFormate);
    ...
    }else if (checkUserPhoneNumberValid == null){
        return checkUserPhoneNumber(); 
    }else if (userAddress === ""){
        return checkUserAddress(); 
    }else if (userZipCode === ""){
        return checkUserZipCode(); 
    }else if (userCity === ""){
...
firebase.auth().onAuthStateChanged((user)=>{
    ...
    //   User is signed in.
        ...
        firebaseRefKey.on('value', (dataSnapShot)=>{
            ...
            document.getElementById("userPfZipCode").innerHTML = dataSnapShot.val().userZipCode;
            document.getElementById("userPfCity").innerHTML = dataSnapShot.val().userCity;
            document.getElementById("userPfCountry").innerHTML = dataSnapShot.val().userCountry;
...
function showEditProfileForm(){
    ...
    var userPfAddress = document.getElementById("userPfAdrress").innerHTML;
    var userPfZipCode = document.getElementById("userPfZipCode").innerHTML;
    var userPfCity = document.getElementById("userPfCity").innerHTML;
    var userPfCountry = document.getElementById("userPfCountry").innerHTML;
    ...
    document.getElementById("userZipCode").value = userPfZipCode;
    document.getElementById("userCity").value = userPfCity;
    document.getElementById("userCountry").value = userPfCountry;
    document.getElementById("userPhoneNumber").value = userPfPhoneNumber;  
...
function saveProfile(){
    ...
    if(checkUserFullNameValid == null){
        ...
        return checkUserCountry(); 
    }else if(checkUserPhoneNumber == null){
        return checkUserPhoneNumber(); 
    }else{
        let user = firebase.auth().currentUser;
        let uid;
